...
function main() {
  //let
  let userCurrency = prompt('What is your current currency? Type "USD", "EUR", "JPY", "GBP", "AUD"\n');
  let currency = prompt('What currency would like to convert to? Type "USD" , "EUR", "JPY", "GBP", "AUD" \n');
  let userValue = prompt(`Your converting (${userCurrency.toUpperCase()}) -> (${currency.toUpperCase()}). What is your current value of your currency (${userCurrency.toUpperCase()})?\n`);
  let result;
  //const
 ...
 //const resultFixedTwo = result.toFixed(2); 
  ...
  function ifFunc(){
    if (userCurrencyUpperCase === "USD" && currencyUpperCase === "USD") {
        result = userValue * 1;
        document.getElementById("result").innerText = message + result.toFixed(2) + " USD"
    } else if (userCurrencyUpperCase === "USD" && currencyUpperCase === "EUR") {
        result = userValue * 0.88;
        document.getElementById("result").innerText = message + result.toFixed(2) + " EUR"
    } else if (userCurrencyUpperCase === "USD" && currencyUpperCase === "AUD") {
        result = userValue * 1.37;
        document.getElementById("result").innerText = message + result.toFixed(2) + " AUD"
    } else if (userCurrencyUpperCase === "USD" && currencyUpperCase === "GBP") {
        result = userValue * 0.69;
        document.getElementById("result").innerText = message + result.toFixed(2) + " GBP"
    } else if (userCurrencyUpperCase === "USD" && currencyUpperCase === "JPY") {
        result = userValue * 108.96;
        document.getElementById("result").innerText = message + result.toFixed(2) + " JPY"
    } else if (userCurrencyUpperCase === "EUR" && currencyUpperCase === "EUR") {
        result = userValue * 1;
        document.getElementById("result").innerText = message + result.toFixed(2) + " EUD"
